...
<body>
	...
	<div class="w3-top">
		<div class="w3-bar w3-red w3-card w3-left-align w3-large">
			...
			<a href="addProduct.jsp" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Add Items </a> 
			<a href="viewProduct.jsp" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">View Items </a> 
			<a href="#" class="w3-bar-item w3-button w3-hide-small w3-padding-large" style="margin-left: 600px;"> <%
 	if (session != null) {
...
<div class="w3-top">
    <div class="w3-bar w3-red w3-card w3-left-align w3-large">
        ...
        <a href="logoutServlet" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white" style="margin-left: 10px;">Logout</a>
    </div>

    <!-- Navbar on small screens -->
    <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium w3-large">
        <a href="#" class="w3-bar-item w3-button w3-padding-large">Vendor Registration</a>
        <a href="#" class="w3-bar-item w3-button w3-padding-large">User Registration</a>
