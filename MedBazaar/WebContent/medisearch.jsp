		...
		<div class="w3-display-middle">
			...
			<form action="serachProduct.jsp">
				<div class="input-group add-on">
					<input class="form-control" placeholder="Medicine" name="srchmedi"
						id="srch-term1" type="text"> <input class="form-control"
						placeholder="Pin Code" name="srchpincode" id="srch-term2"
						type="text">
...
-->
				...
				<center>
					<button class="w3-center button button4 ">Search</button>
				</center>
			</form>
		</div>
