    ...
    <div class="w3-container w3-card-4 "
        ...
        <form action="UpdateProdServ" method="post">
            <div class="float-container" style="margin-top: 20px">
                <div class="float-child">
                    <h3 style="margin-top: 20px">Product Name</h3>
                    <input type='text' name='pname' value='<%= pname %>' style="padding: 20px;" required>
                    <h3 style="margin-top: 20px">Product ID</h3>
                    <input type='text' name='pid' value="<%= pid %>" style="padding: 20px;" readonly>
                    <h3 style="margin-top: 20px">Manufacturer Name</h3><input type='text' name='mname'
                                                                            value="<%= mname %>" style="padding: 20px;" required>
                    <h3 style="margin-top: 20px">Manufacture Date</h3><input type="text" name="mgfdate"
                                                                            value="<%= mft_date %>" placeholder="YYYY-MM-DD" onkeypress="return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 45"
                                                                            style="padding: 20px;" required>
                    <h3 style="margin-top: 20px">Expiry Date</h3><input type="text" name="expdate"
                                                                    value="<%= exp_date %>" placeholder="YYYY-MM-DD" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57) || event.charCode == 45)"
                                                                    style="padding: 20px;" required>
                </div>
                <div class="float-child">
                    <h3 style="margin-top: 20px">Power</h3><input type="text" name="power"
                                                                value="<%= power %>" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57) || event.charCode == 45)"
                                                                style="padding: 20px;" required>
                    <h3 style="margin-top: 20px">Quantity</h3><input type="text" name="quantity"
                                                                    value="<%= quantity %>" onkeypress="return event.charCode >= 48 && event.charCode <= 57" style="padding: 20px;"
                                                                    required>
                    <h3 style="margin-top: 20px">Price</h3><input type="text" name="price"
                                                                value="<%= price %>" onkeypress="return event.charCode >= 48 and event.charCode <= 57" style="padding: 20px;"
                                                                required>
                    <p></p>
                    <h3><input type="submit" class="upbutton" value="Update" style="margin-left: 10px; margin-top: 15px; "></h3>
                </div>
